...
export default function EntryForm() {
  ...
  return (
    <form
      className="grid bg-gray-200 rounded overflow-hidden shadow-lg p-2.5 mr-2.5"
    ...
    >
      ...
      <input
        placeholder="Ex. Great weekend trip to..."
        type="text"
        className="rounded"
      ...
      <button className="text-white rounded bg-indigo-500 mt-2 hover:bg-indigo-400">
        Submit Entry
      </button>
